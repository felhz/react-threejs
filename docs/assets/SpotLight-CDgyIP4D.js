import{s as P,x as S,V as y,b as _,d as E,_ as M,u as h,a as b,ab as C,j as w}from"./react-three-fiber.esm-C8M_wf_e.js";import{r as e}from"./ssg-client-jqSihuOd.js";const I=()=>parseInt(P.replace(/\D+/g,"")),N=I();class V extends S{constructor(){super({uniforms:{depth:{value:null},opacity:{value:1},attenuation:{value:2.5},anglePower:{value:12},spotPosition:{value:new y(0,0,0)},lightColor:{value:new _("white")},cameraNear:{value:0},cameraFar:{value:1},resolution:{value:new E(0,0)}},transparent:!0,depthWrite:!1,vertexShader:`
