import{r as P,w as S,V as y,b as _,c as E,_ as M,u as h,a as b,ab as C,i as w}from"./react-three-fiber.esm-W9vqQav0.js";import{r as e}from"./ssg-client-GvFJdTbJ.js";const I=()=>parseInt(P.replace(/\D+/g,"")),N=I();class V extends S{constructor(){super({uniforms:{depth:{value:null},opacity:{value:1},attenuation:{value:2.5},anglePower:{value:12},spotPosition:{value:new y(0,0,0)},lightColor:{value:new _("white")},cameraNear:{value:0},cameraFar:{value:1},resolution:{value:new E(0,0)}},transparent:!0,depthWrite:!1,vertexShader:`
