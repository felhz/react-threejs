import{p as s}from"./index_-nQuHDAdD.js";import{j as r,u as l}from"./ssg-client-B4kbL9vE.js";const o=e=>{for(let n=0;n<e.length;n++)for(let t=0;t<e.length-1;t++)if(e[t]>e[t+1]){const i=e[t];e[t]=e[t+1],e[t+1]=i}return e},u=()=>{let e=[3,5,1,4,2],n=[...e];return console.log(o(e)),r.jsxs("div",{children:["输入:",n.toString()," ",r.jsx("br",{}),"输出: ",o(e).toString()]})},d=`import React from 'react'
