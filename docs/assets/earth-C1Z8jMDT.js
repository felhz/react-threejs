import{p as j}from"./earth_-FU1-d8Ot.js";import{j as e,r as P,u as i}from"./ssg-client-Dg7YBUPF.js";import{C,a,O as v,A as S,V as T,u as H,b,c as o,d as R,L as y,T as I,S as s}from"./OrbitControls-BaRFn3-G.js";import{G as F,a as L}from"./GizmoViewport-CSqHPst1.js";function _(){const r=new S(0,0,20,0,Math.PI*2,!1),l=r.getPoints(50),[m,p]=P.useState(new T),u=H(I,"/react-threejs/earth.jpg"),h=new s(10,Math.PI/180*0,0),d=new s(12,Math.PI/180*45,0),f=new s(13,Math.PI/180*90,0),E=new s(12,Math.PI/180*135,0),w=new s(10,Math.PI/180*180,0);return new b([new o().setFromSpherical(h),new o().setFromSpherical(d),new o().setFromSpherical(f),new o().setFromSpherical(E),new o().setFromSpherical(w)],!1,"catmullrom",.5).getPoints(100),R(g=>{const x=g.clock.getElapsedTime()/15%1,M=r.getPointAt(x);p(M)}),e.jsxs("group",{children:[e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[10]}),e.jsx("meshStandardMaterial",{map:u})]}),e.jsxs("mesh",{children:[e.jsx(y,{points:l,color:new a(65280)}),e.jsxs("mesh",{position:[...m,0],children:[e.jsx("sphereGeometry",{args:[1]}),e.jsx("meshBasicMaterial",{color:new a(255),opacity:.5,transparent:!0})]})]})]})}const G=()=>e.jsxs(C,{shadows:!0,dpr:[1,2],style:{height:"80vh"},gl:{alpha:!1},scene:{background:new a(16777215)},camera:{position:[0,0,80],fov:45},children:[e.jsx(v,{}),e.jsx(F,{children:e.jsx(L,{axisColors:["red","green","blue"],labelColor:"black"})}),e.jsx("ambientLight",{intensity:Math.PI}),e.jsx(_,{})]}),V=`import {
  GizmoHelper,
  GizmoViewport,
  Line,
  OrbitControls,
