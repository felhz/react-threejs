import{p as j}from"./earth_-FU1-d8Ot.js";import{j as e,r as P,u as i}from"./ssg-client-DElkHeyq.js";import{C,b as a,A as v,c as S,d as T,T as H,e as o,f as b,V as s,a as R}from"./react-three-fiber.esm-DG6tMjmU.js";import{O as y}from"./OrbitControls-BNyP8YTw.js";import{G as I,a as F}from"./GizmoViewport-C53MY05x.js";import{L}from"./Line-DdbIPyJL.js";import"./Hud-Bt2QLWPS.js";function _(){const r=new v(0,0,20,0,Math.PI*2,!1),l=r.getPoints(50),[m,p]=P.useState(new S),u=T(H,"/react-threejs/earth.jpg"),h=new o(10,Math.PI/180*0,0),d=new o(12,Math.PI/180*45,0),f=new o(13,Math.PI/180*90,0),E=new o(12,Math.PI/180*135,0),w=new o(10,Math.PI/180*180,0);return new b([new s().setFromSpherical(h),new s().setFromSpherical(d),new s().setFromSpherical(f),new s().setFromSpherical(E),new s().setFromSpherical(w)],!1,"catmullrom",.5).getPoints(100),R(g=>{const x=g.clock.getElapsedTime()/15%1,M=r.getPointAt(x);p(M)}),e.jsxs("group",{children:[e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[10]}),e.jsx("meshStandardMaterial",{map:u})]}),e.jsxs("mesh",{children:[e.jsx(L,{points:l,color:new a(65280)}),e.jsxs("mesh",{position:[...m,0],children:[e.jsx("sphereGeometry",{args:[1]}),e.jsx("meshBasicMaterial",{color:new a(255),opacity:.5,transparent:!0})]})]})]})}const G=()=>e.jsxs(C,{shadows:!0,dpr:[1,2],style:{height:"80vh"},gl:{alpha:!1},scene:{background:new a(16777215)},camera:{position:[0,0,80],fov:45},children:[e.jsx(y,{}),e.jsx(I,{children:e.jsx(F,{axisColors:["red","green","blue"],labelColor:"black"})}),e.jsx("ambientLight",{intensity:Math.PI}),e.jsx(_,{})]}),V=`import {
  GizmoHelper,
  GizmoViewport,
  Line,
  OrbitControls,
