import{p as j}from"./earth_-FU1-d8Ot.js";import{j as e,r as P,u as i}from"./ssg-client-DrLVhK43.js";import{K as v,Q as a,Y as C,Z as S,v as T,$ as o,a0 as H,V as s,z as R,X as b}from"./react-three-fiber.esm-CpNsHlsP.js";import{O as y}from"./OrbitControls-Bk6UaeQa.js";import{G as I,a as F}from"./GizmoViewport-B6RUJ1h1.js";import{L}from"./Line-CnBcGKse.js";import"./Hud-DLqYbN00.js";function _(){const r=new C(0,0,20,0,Math.PI*2,!1),l=r.getPoints(50),[m,p]=P.useState(new S),u=T(b,"/react-threejs/earth.jpg"),h=new o(10,Math.PI/180*0,0),d=new o(12,Math.PI/180*45,0),f=new o(13,Math.PI/180*90,0),E=new o(12,Math.PI/180*135,0),w=new o(10,Math.PI/180*180,0);return new H([new s().setFromSpherical(h),new s().setFromSpherical(d),new s().setFromSpherical(f),new s().setFromSpherical(E),new s().setFromSpherical(w)],!1,"catmullrom",.5).getPoints(100),R(g=>{const x=g.clock.getElapsedTime()/15%1,M=r.getPointAt(x);p(M)}),e.jsxs("group",{children:[e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[10]}),e.jsx("meshStandardMaterial",{map:u})]}),e.jsxs("mesh",{children:[e.jsx(L,{points:l,color:new a(65280)}),e.jsxs("mesh",{position:[...m,0],children:[e.jsx("sphereGeometry",{args:[1]}),e.jsx("meshBasicMaterial",{color:new a(255),opacity:.5,transparent:!0})]})]})]})}const G=()=>e.jsxs(v,{shadows:!0,dpr:[1,2],style:{height:"80vh"},gl:{alpha:!1},scene:{background:new a(16777215)},camera:{position:[0,0,80],fov:45},children:[e.jsx(y,{}),e.jsx(I,{children:e.jsx(F,{axisColors:["red","green","blue"],labelColor:"black"})}),e.jsx("ambientLight",{intensity:Math.PI}),e.jsx(_,{})]}),V=`import {
  GizmoHelper,
  GizmoViewport,
  Line,
  OrbitControls,
...
export default Map
`,z=void 0,O=void 0,D={code:V,title:z,desc:O},k=!0,A=Object.freeze(Object.defineProperty({__proto__:null,default:G,demoMeta:D,isDemo:k},Symbol.toStringTag,{value:"Module"}));function n(t){const{Demo:r}={...i(),...t.components};return r||B("Demo"),e.jsx(r,{...A})}function X(t={}){const{wrapper:r}={...i(),...t.components};return r?e.jsx(r,{...t,children:e.jsx(n,{...t})}):n(t)}function B(t,r){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}const K=Object.freeze(Object.defineProperty({__proto__:null,default:X},Symbol.toStringTag,{value:"Module"})),c={};c.outlineInfo=j;c.main=K;export{c as default};
