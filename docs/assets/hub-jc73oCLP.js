import{p as D}from"./hub_-FU1-d8Ot.js";import{r as e,j as r,u as P}from"./ssg-client-CkOz89ez.js";import{d as v,u as E,_ as k,f as L,g as z,h as X,C as G,a as q,O as $,M as A}from"./OrbitControls-DPVObLsO.js";import{C as B}from"./shapes-DHK84nWl.js";import{u as H,H as J,O as K}from"./Hud-8b5Q5Xno.js";import{T as N}from"./Text-M42r2nZs.js";const Q=t=>typeof t=="function",U=e.forwardRef(({envMap:t,resolution:a=256,frames:i=1/0,makeDefault:f,children:l,...u},d)=>{const m=v(({set:o})=>o),p=v(({camera:o})=>o),n=v(({size:o})=>o),s=e.useRef(null);e.useImperativeHandle(d,()=>s.current,[]);const g=e.useRef(null),y=H(a);e.useLayoutEffect(()=>{u.manual||(s.current.aspect=n.width/n.height)},[n,u]),e.useLayoutEffect(()=>{s.current.updateProjectionMatrix()});let h=0,b=null;const c=Q(l);return E(o=>{c&&(i===1/0||h<i)&&(g.current.visible=!1,o.gl.setRenderTarget(y),b=o.scene.background,t&&(o.scene.background=t),o.gl.render(o.scene,s.current),o.scene.background=b,o.gl.setRenderTarget(null),g.current.visible=!0,h++)}),e.useLayoutEffect(()=>{if(f){const o=p;return m(()=>({camera:s.current})),()=>m(()=>({camera:o}))}},[s,f,m]),e.createElement(e.Fragment,null,e.createElement("perspectiveCamera",k({ref:s},u),!c&&l),e.createElement("group",{ref:g},c&&l(y.texture)))}),V=e.forwardRef(({children:t,compute:a,width:i,height:f,samples:l=8,renderPriority:u=0,eventPriority:d=0,frames:m=1/0,stencilBuffer:p=!1,depthBuffer:n=!0,generateMipmaps:s=!1,...g},y)=>{const{size:h,viewport:b}=v(),c=H((i||h.width)*b.dpr,(f||h.height)*b.dpr,{samples:l,stencilBuffer:p,depthBuffer:n,generateMipmaps:s}),[o]=e.useState(()=>new L),F=e.useCallback((S,j,C)=>{var T,w;let x=(T=c.texture)==null?void 0:T.__r3f.parent;for(;x&&!(x instanceof z);)x=x.__r3f.parent;if(!x)return!1;C.raycaster.camera||C.events.compute(S,C,(w=C.previousRoot)==null?void 0:w.getState());const[M]=C.raycaster.intersectObject(x);if(!M)return!1;const R=M.uv;if(!R)return!1;j.raycaster.setFromCamera(j.pointer.set(R.x*2-1,R.y*2-1),j.camera)},[]);return e.useImperativeHandle(y,()=>c.texture,[c]),e.createElement(e.Fragment,null,X(e.createElement(W,{renderPriority:u,frames:m,fbo:c},t,e.createElement("group",{onPointerOver:()=>null})),o,{events:{compute:a||F,priority:d}}),e.createElement("primitive",k({object:c.texture},g)))});function W({frames:t,renderPriority:a,children:i,fbo:f}){let l=0,u,d,m,p;return E(n=>{(t===1/0||l<t)&&(u=n.gl.autoClear,d=n.gl.xr.enabled,m=n.gl.getRenderTarget(),p=n.gl.xr.isPresenting,n.gl.autoClear=!0,n.gl.xr.enabled=!1,n.gl.xr.isPresenting=!1,n.gl.setRenderTarget(f),n.gl.render(n.scene,n.camera),n.gl.setRenderTarget(m),n.gl.autoClear=u,n.gl.xr.enabled=d,n.gl.xr.isPresenting=p,l++)},a),e.createElement(e.Fragment,null,i)}let _=new A;const Y=t=>r.jsxs(V,{attach:"map",children:[r.jsx("color",{attach:"background",args:["white"]}),r.jsx(K,{makeDefault:!0,left:-1,right:1,top:1,bottom:-1,position:[0,0,10],zoom:.5}),r.jsx(N,{color:"red",children:t.text})]});function Z(){const{camera:t,viewport:a}=v(),i=e.useRef();return e.useEffect(()=>{console.log(a,"viewport",t)},[]),E(()=>{_.copy(t.matrix).invert(),i.current.quaternion.setFromRotationMatrix(_)}),r.jsxs(J,{children:[r.jsx(U,{makeDefault:!0,position:[5,3,10]}),r.jsx("ambientLight",{intensity:Math.PI}),r.jsxs("mesh",{ref:i,children:[r.jsx("boxGeometry",{}),r.jsx("meshStandardMaterial",{color:"hotpink",children:r.jsx(Y,{text:"1"})})]})]})}const ee=()=>r.jsxs(G,{shadows:!0,gl:{alpha:!1},scene:{background:new q(16777215)},children:[r.jsx($,{}),r.jsx("ambientLight",{intensity:Math.PI}),r.jsx(Z,{}),r.jsx(B,{"material-color":"hotpink"})]}),te=`import {
  Circle,
  Hud,
  OrbitControls,
  OrthographicCamera,
