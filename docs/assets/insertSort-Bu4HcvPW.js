...
`})}),`
`,t.jsx(o,{...p})]})}function S(e={}){const{wrapper:n}={...l(),...e.components};return n?t.jsx(n,{...e,children:t.jsx(c,{...e})}):c(e)}function x(e,n){throw new Error("Expected component `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}const _=Object.freeze(Object.defineProperty({__proto__:null,default:S},Symbol.toStringTag,{value:"Module"})),s={};s.outlineInfo=a;s.main=_;export{s as default};
