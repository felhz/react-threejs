import{p as a}from"./index_-nQuHDAdD.js";import{j as t,u as c}from"./index-CrfNMau9.js";const i=e=>{for(let n=1;n<e.length;n++){const o=e[n];let r=n-1;for(;r>=0&&e[r]>o;)e[r+1]=e[r],r--;e[r+1]=o}return e},d=()=>{const e=[3,5,1,4,2];let n=[...e];return console.log(i(e)),t.jsxs("div",{children:["输入:",n.toString()," ",t.jsx("br",{}),"输出: ",i(e).toString()]})},m=`import React from 'react'
