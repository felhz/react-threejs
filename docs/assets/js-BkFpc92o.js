import{p as m}from"./_-nQuHDAdD.js";import{r as o,j as e,u as r}from"./ssg-client-DrLVhK43.js";const p=()=>{const[t,n]=o.useState('{"name": 12,"age": null}'),[l,u]=o.useState(""),c=i=>{n(i.target.value)},d=()=>{u(JSON.stringify(JSON.parse(t)))};return e.jsxs("div",{children:[e.jsx("textarea",{value:t,onChange:c}),e.jsx("br",{}),e.jsx("button",{onClick:d,children:"解析"}),e.jsx("br",{}),e.jsx("textarea",{value:l})]})},f=`import React, { useState } from 'react'
