import{p as j}from"./light_-FU1-d8Ot.js";import{r as t,j as e,u as S}from"./ssg-client-osvJgeis.js";import{q as E,v as _,V as M,b as C,c as L,_ as D,u as x,a as I,a8 as R,h as w,a9 as T,C as Z,aa as F,D as H}from"./react-three-fiber.esm-btdE3oaG.js";import{O as N}from"./OrbitControls-DlIYYkXU.js";import{B as O,S as V}from"./shapes-CI6dVy3N.js";const z=()=>parseInt(E.replace(/\D+/g,"")),k=z();class X extends _{constructor(){super({uniforms:{depth:{value:null},opacity:{value:1},attenuation:{value:2.5},anglePower:{value:12},spotPosition:{value:new M(0,0,0)},lightColor:{value:new C("white")},cameraNear:{value:0},cameraFar:{value:1},resolution:{value:new L(0,0)}},transparent:!0,depthWrite:!1,vertexShader:`
