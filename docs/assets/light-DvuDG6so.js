import{p as j}from"./light_-FU1-d8Ot.js";import{r as t,j as e,u as S}from"./ssg-client-DWAOL2h1.js";import{R as E,S as _,V as M,b as C,Z as L,_ as D,u as x,a as I,ax as R,a5 as w,ay as Z,C as T,az as F,D as H}from"./react-three-fiber.esm-DbDymmc8.js";import{O as N}from"./OrbitControls-BabokWbx.js";import{B as O,S as V}from"./shapes-BiFN5HBI.js";const z=()=>parseInt(E.replace(/\D+/g,"")),k=z();class X extends _{constructor(){super({uniforms:{depth:{value:null},opacity:{value:1},attenuation:{value:2.5},anglePower:{value:12},spotPosition:{value:new M(0,0,0)},lightColor:{value:new C("white")},cameraNear:{value:0},cameraFar:{value:1},resolution:{value:new L(0,0)}},transparent:!0,depthWrite:!1,vertexShader:`
