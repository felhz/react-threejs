import{p as c}from"./pano_-FU1-d8Ot.js";import{r as m,j as t,u as r}from"./ssg-client-4zDxi0Zf.js";import{u as p,r as u,as as l,C as f}from"./react-three-fiber.esm-BEwSLRIS.js";import{s as d}from"./index-CSwHO5PT.js";import{u as x}from"./Texture-Cmilkyr_.js";import{O as g}from"./OrbitControls-DmoKBF3_.js";let b=["/pano/left.png","/pano/right.png","/pano/top.png","/pano/bottom.png","/pano/front.png","/pano/back.png"].map(e=>d+e);const h=()=>{const{gl:e,camera:n}=p(),a=x(b);return m.useEffect(()=>{e.setSize(300,300),n.position.set(1,0,-1.5)},[]),t.jsx("mesh",{scale:[3,3,3],material:a.map((i,T)=>new u({map:i,side:l})),children:t.jsx("boxGeometry",{args:[3,3,3]})})},j=()=>t.jsxs(f,{children:[t.jsx(g,{enableZoom:!1}),t.jsx("ambientLight",{intensity:Math.PI}),t.jsx(h,{})]}),_=`import { OrbitControls } from '@react-three/drei';
