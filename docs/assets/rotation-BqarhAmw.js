import{p as a}from"./rotation_-FU1-d8Ot.js";import{j as e,r as i,u as r}from"./ssg-client-jqSihuOd.js";import{C as c,b as m,u as l,a as u}from"./react-three-fiber.esm-C8M_wf_e.js";import{O as f}from"./OrbitControls-IfKY8eh_.js";function d(){l();const n=i.useRef();return u(()=>{}),e.jsx(e.Fragment,{children:e.jsxs("mesh",{ref:n,children:[e.jsx("meshBasicMaterial",{color:"red",opacity:.1}),e.jsx("boxGeometry",{args:[1,1,5],translateX:1})]})})}const p=()=>e.jsx("div",{style:{height:"60vh"},children:e.jsxs(c,{dpr:[1,2],scene:{background:new m(15390897)},gl:{alpha:!1},camera:{position:[0,0,37],fov:45},children:[e.jsx(f,{}),e.jsx("axesHelper",{args:[10]}),e.jsx("ambientLight",{intensity:Math.PI}),e.jsx(d,{}),e.jsx("directionalLight",{position:[0,20,20]})]})}),h=`import { OrbitControls } from '@react-three/drei'
