import{p as r}from"./_-C3c3qQ6q.js";import{r as i,j as e,u as d}from"./ssg-client-CyA5FH7a.js";class w{constructor(){this.windowSnapshoot={},this.modifyMap={},console.log("Sandbox")}active(){for(const n in window)this.windowSnapshoot[n]=window[n];Object.keys(this.modifyMap).forEach(n=>{window[n]=this.modifyMap[n]})}inActive(){for(const n in window)window[n]!==this.windowSnapshoot[n]&&(this.modifyMap[n]=window[n],window[n]=this.windowSnapshoot[n])}}const s=new w,f=()=>{const[o,n]=i.useState(!0);return i.useEffect(()=>{o?s.active():s.inActive()},[o]),e.jsxs("div",{children:["是否激活沙箱:",e.jsx("input",{type:"checkbox",checked:o,onChange:t=>{n(t.target.checked)}})]})},h=`import { useEffect, useState } from 'react'
