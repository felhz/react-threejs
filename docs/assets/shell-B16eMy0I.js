import{p as i}from"./_-BbONP_Ue.js";import{u as c,j as e}from"./ssg-client-CTSCcih9.js";function s(r){const n={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...c(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{id:"搜索当前目录文件名包含指定字符串的文件",children:"搜索当前目录文件名包含指定字符串的文件"}),`
